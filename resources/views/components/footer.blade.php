<footer class="footer-part relative">
    ...
    <div class="container relative z-1">
      ...
      <div class="flex flex-wrap  -mx-4 pt-10 border-t border-gray-100">
        <div class="w-full lg:w-1/3 px-3 mx-auto">
          <!-- footer column -->
            <div class="mb-10 lg:mb-6 text-left lg:max-w-[260px] mx-auto">
      ...
      <div class="border-t border-gray-100 py-4 text-center md:text-left md:flex items-center justify-between">
        <p class="text-dark-900 text-md mb-0">Copyright 2023 <a href="index-1.html" class="text-primary-900 hover:text-dark-900"></a>. All Rights Reserved.</p>
        <p class="text-dark-900 text-md mb-0">Design by <a href="#" class="text-primary-900 hover:text-dark-900">Hariti asmaa</a>.</p>
      </div>
